...
<body style="background-color: lightblue">
 <!-- <h1 class="badge bg-secondary">Grade Portal</h1>
 <ul>
 <li><a href="<%= request.getContextPath() %>/home.jsp"><h3>Home</h3></a></li>
 <li><a href="<%= request.getContextPath() %>/StudentLogin.jsp"><h3>StudentLogin</h3></a></li>
 <li><a href="<%= request.getContextPath() %>/StaffLogin.jsp"><h3>StaffLogin</h3></a></li>
 </ul> -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <!-- <a class="nav-link" href="<%= request.getContextPath() %>/StudentLogin.jsp">StudentLogin</a>
        <a class="nav-link" href="<%= request.getContextPath() %>/StaffLogin.jsp">StaffLogin</a> -->
